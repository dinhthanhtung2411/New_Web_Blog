    ...
    <div class="container-login100" style="background-image: url({{asset('images/bg-01.jpg')}});">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form class="login100-form validate-form"
                ...
                @error('email')
                <p style="color: red; display: inline-block; !important;">{{ $message }}</p>
                @enderror
                ...
                @else
                    ...
                    <div class="text-right p-t-8 p-b-31">
                        <label class="checkbox" style="margin-right: 120px;font-size: 15px; margin-top: 5px; !important;" >
                            <input type="checkbox" value="remember-me" name="remember" style="position: absolute;margin-left: 1px"><span style="margin-left: 19px">Remember me</span>
                        </label>
                        <a href="#">
                            Forgot password?
                        </a>
